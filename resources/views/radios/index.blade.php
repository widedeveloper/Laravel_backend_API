                                        ...
                                        <tbody>
                                            ...
                                            foreach ($regions as $tr):
                                                ...
                                                <tr class="gradeA odd" item_id="<?php echo $tr->id ?>">
                                                    ...
                                                    <td class=" "><?php echo $tr->country_name ?></td>
                                                    ...
                                                    <td class="center ">
                                                        ...
                                                        <a href="{{ url('regions/delete/'.$tr->id)}}" data-method="delete" class="btn btn-danger btn-xs delete"><i class="fa fa-pencil "></i> Delete</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
