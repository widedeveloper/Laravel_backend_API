        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" id="user_form" name="user_form" action="/users/{{ $user->id }}" method = "post">
                        ...
                        <div class="box-body">
                            <div class="form-group custom_input">
                                ...
                                <div class="col-xs-4">
                                    <input class="form-control" name="name" type="text" value="{{ $user->name }}" placeholder="Name" required>
                                </div>
                            </div>
                            <div class="form-group custom_input">
