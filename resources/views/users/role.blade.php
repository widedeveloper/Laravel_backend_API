            ...
            <div class="col-xs-12">               
                ...
                <div class="box account_list">
                    ...
                    <div class="box-header with-border">
                        <a href="{{url('/roles/create')}}" class="btn btn-info ">Add New</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                        <thead>
                                            <tr role="row">
                                                <th style="width: 268px;"><input type="checkbox" /></th>
                                                <th style="width: 268px;">Title</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($roles as $tr):
                                                ...
                                                <tr class="gradeA odd" item_id="<?php echo $tr->id ?>">
                                                    ...
                                                    <td class="center ">
                                                        <a data-href="{{URL::to('roles/<?php echo $tr->id ?>')}}" class="btn btn-primary btn-xs view"><i class="fa fa-edit "></i> view</a>
                                                        <a onclick="edit($(this))" class="btn btn-danger btn-xs edit"><i class="fa fa-pencil "></i> Edit</a>                                                       
                                                        <a href="{{ url('roles/delete/'.$tr->id)}}" data-method="delete" class="btn btn-danger btn-xs delete"><i class="fa fa-pencil "></i> Delete</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
