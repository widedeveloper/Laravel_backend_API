                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                    ...
                                    <div class="box-header with-border">
                                        <a href="{{url('/episodes/create')}}" class="btn btn-info ">Add New</a>
                                    </div>
                                        <div class="box-body">
                                            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                                            <thead>
                                                                <tr role="row">
                                                                    ...
                                                                    <th style="width:15%;">Podcast Title</th>
                                                                ...
                                                                @foreach ($episodes as $tr)
                                                                    <tr class="gradeA odd" item_id="{{$tr->id}}">
                                                                        ...
                                                                        <td class="center ">
                                                                            ...
                                                                            <a onclick="radio_delete($(this))" data-href="{{ url('episodes/delete/'.$tr->id)}}" data-method="delete" class="btn btn-danger btn-xs delete"><i class="fa fa-pencil "></i> Delete</a>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
                                                            </tbody>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-3">
                                                                <div class="dataTables_info" id="dataTables-example_info" role="alert" aria-live="polite" aria-relevant="all">Tatal <?php echo $episodes->total() ?> counts</div>
